...
describe('test server', () => {
	...
	describe('pizzas ', () => {
		...
		test('response has expected number of pizzas, and each has a name and image', () => {
			return request(server)
				.get('/pizzas')
				.then((response) => {
	...
	describe('toppings', () => {
		...
		test('response has expected number of pizza toppings, and each has a name and image', () => {
			return request(server)
				.get('/toppings')
				.then((response) => {
